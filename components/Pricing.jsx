  ...
  return (
    <section id="pricing" className="py-24 bg-black">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Our Website Packages</h2>
        ...
        <div className={`mt-16 text-center transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-400 mb-6">Can't find what you're looking for? Let's chat!</p>
          <button className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-500 transition-colors mr-4">
            Chat
          </button>
