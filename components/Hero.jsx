...
//               <a 
//                 href="/resume.pdf" 
//                 download="Rodgers_Chisale_CV.pdf"
...
const Hero = () => {
  ...
  const handleDownload = () => {
    // Ensure the PDF exists in public/resume.pdf
    const filePath = "/resume.pdf"; 

    // Create a hidden anchor and trigger click
    const link = document.createElement("a");
    link.href = filePath;
    link.download = "Rodgers_Chisale_CV.pdf"; // The name it will save as
    ...
    <section id="home" className="min-h-screen pt-24 bg-black">
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="flex flex-col items-center justify-between gap-12 md:flex-row">
          ...
          >
            <h1 className="mb-6 text-5xl font-bold text-white">Hello! I'm</h1>
            <h1 className="mb-8 text-5xl font-bold italic text-blue-400">
              RODGERS CHISALE,
            </h1>
            <p className="mb-10 max-w-xl text-xl text-gray-400">
